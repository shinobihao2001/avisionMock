...
module.exports = {
  ...
  rowNav: `<li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-12782"><a href="http://${mainDomain}/product-category/medical/" class="elementor-item">Hệ thống tổng đại lý</a></li>`,
  colNav: `<li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-12782"><a href="http://${mainDomain}/product-category/medical/" class="elementor-item" tabindex="0">Hệ thống đại lý</a></li>`,
...
<h2 class="elementor-heading-title elementor-size-default"><a href="http://${mainDomain}/agent/">Hệ thống đại lý</a></h2>		</div>
  </div>`,
};
