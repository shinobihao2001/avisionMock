...
const ulti = require("./src/services/ulti.js");
...
//     //Step 5: Translate and modify all page and save them to local
...
module.exports = {
  CrawlFunction: async () => {
    try {
      ...
      //Step 2.5 => Save all link html to onlinePage
      // don't crawl partner portal  and product register any more because it now require login
      await linkService.saveAllUrl(links);
      console.log("Save all url to html done");
